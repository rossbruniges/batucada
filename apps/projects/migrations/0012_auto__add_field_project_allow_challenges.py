...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.allow_challenges'
        db.add_column('projects_project', 'allow_challenges', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.allow_challenges'
        db.delete_column('projects_project', 'allow_challenges')
