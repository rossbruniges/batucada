...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.sub_projects_metaname'
        db.add_column('projects_project', 'sub_projects_metaname', self.gf('django.db.models.fields.CharField')(default='Sub-project', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.sub_projects_metaname'
        db.delete_column('projects_project', 'sub_projects_metaname')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 8, 1)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'sub_projects_metaname': ('django.db.models.fields.CharField', [], {'default': "'Sub-project'", 'max_length': '100'})
        },
