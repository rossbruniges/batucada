...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.allow_subProjects'
        db.add_column('projects_project', 'allow_subProjects', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.allow_subProjects'
        db.delete_column('projects_project', 'allow_subProjects')
