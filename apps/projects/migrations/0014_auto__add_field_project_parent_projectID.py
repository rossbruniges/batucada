...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.parent_projectID'
        db.add_column('projects_project', 'parent_projectID', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.parent_projectID'
        db.delete_column('projects_project', 'parent_projectID')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'allow_challenges': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_subProjects': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'projects'", 'to': "orm['users.UserProfile']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 7, 25)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'parent_projectID': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
