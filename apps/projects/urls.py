...
urlpatterns = patterns('',
  ...
  url(r'^create/sub-project/(?P<parent>\d+)/$',
    'projects.views.create',
    name='sub_project_create'),
  url(r'^(?P<slug>[\w-]+)/$', 'projects.views.show',
      name='projects_show'),
  url(r'^(?P<slug>[\w-]+)/description/$', 'projects.views.show_detailed',
      name='projects_show_detailed'),
  url(r'^for/(?P<slug>[\w-]+)/$', 'projects.views.show_sub_projects',
    name='projects_sub_projects'),
  url(r'^(?P<slug>[\w-]+)/all_challenges/$', 'projects.views.project_challenges',
